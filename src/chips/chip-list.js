                ...
                if (deleteElement && this.enableDelete ) {
                    ...
                    this.trigger('delete', deletedItemArgs, function (observedArgs) {
                        if (!observedArgs.cancel) {
                            ...
                            _this.selectionHandler(observedArgs.element);
                            chipData.selected = observedArgs.element.classList.contains(exports.classNames.active);
                    ...
                    chipData.selected = chipWrapper.classList.contains(exports.classNames.active);
                    var selectedItemArgs = chipData;
